            ...
            <div class="span-12 inner">
                ...
                <div class="box dark">
                    ...
                    <div class="accordion-body collapse in body">
                        <form class="form-horizontal" action="<?=base_url()?>admin/KategoriEkle/ekle" method="post">
                            <div class="control-group">
                                <label for="kategoriAdi" class="control-label">Kategori Adı</label>
                                <div class="controls with-tooltip">
                                    <input type="text" id="kategoriAdi" name="kategoriAdi" class="span6 input-tooltip" data-placement="bottom">
                                </div>
                            </div>
                            <div class="control-group">
