    ...
    <div class="container-fluid outer">
        <div class="row-fluid">
            <div class="span-12 inner">
                ...
                <?php } ?>
                <div class="box dark">
                    <header><h5>MÜŞTERİ EKLE</h5></header>
                    <div class="accordion-body collapse in body">
                        <form class="form-horizontal" action="<?= base_url() ?>admin/MusteriEkle/ekle" method="post">
                            <div class="control-group">
                                <label for="musteriAdi" class="control-label">Adı</label>
                                <div class="controls with-tooltip">
                                    <input type="text" id="musteriAdi" name="musteriAdi" class="span6 input-tooltip" data-placement="bottom">
                                </div>
                            </div>
                            <div class="control-group">
                                <label for="musteriSoyadi" class="control-label">Soyadı</label>
                                <div class="controls with-tooltip">
                                    <input type="text" id="musteriSoyadi" name="musteriSoyadi" class="span6 input-tooltip" data-placement="bottom">
                                </div>
                            </div>
                            <div class="control-group">
                                <label for="musteriEmail" class="control-label">Email</label>
                                <div class="controls with-tooltip">
                                    <input type="text" id="musteriEmail" name="musteriEmail" class="span6 input-tooltip" data-placement="bottom">
                                </div>
                            </div>
                            <div class="control-group">
                                <label for="musteriSifre" class="control-label">Şifre</label>
                                <div class="controls with-tooltip">
                                    <input type="password" id="musteriSifre" name="musteriSifre" class="span6 input-tooltip" data-placement="bottom">
                                </div>
                            </div>
                            <div class="control-group">
                                <label for="musteriSifre2" class="control-label">Tekrar Şifre Girin</label>
                                <div class="controls with-tooltip">
                                    <input type="password" id="musteriSifre2" name="musteriSifre2" class="span6 input-tooltip" data-placement="bottom">
                                </div>
                            </div>
                            <div class="control-group">
                                <label for="musteriTel" class="control-label">Telefon</label>
                                <div class="controls with-tooltip">
                                    <input type="text" id="musteriTel" name="musteriTel" class="span6 input-tooltip" data-placement="bottom">
                                </div>
                            </div>
                            <div class="control-group">
